...
const FIRE_CORE = { r: 255, g: 244, b: 214 };
const FIRE_MID = { r: 255, g: 168, b: 60 };
const FIRE_EDGE = { r: 214, g: 62, b: 34 };
const SMOKE = { r: 96, g: 92, b: 104 };
/**
...
export class Explosion {
    constructor(x, y, maxRadius, power, chainDepth = 0) {
...
export class Effects {
    ...
    spawnBlast(x, y, scale, hullColor) {
